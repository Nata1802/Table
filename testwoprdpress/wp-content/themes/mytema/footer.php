	<footer>
        <div class="footer-content">
                ...
                <div class="social">
                    ...
                    <a href="http://vk.com/" class="social-icon icon-vk"></a>
                    ...
                    <a href="http://instagram.com/" class="social-icon-small icon-instagram1"></a>
                    <a href="/rss/" class="social-icon-small rss-icon"></a>
                </div>
                <div class="footer-logo">
                    <a href="/"><img src="<?php bloginfo('template_url'); ?>/img/logo.png" class ="logo"></a>
                    <p><?php echo __('Copyright © 2012 Whitesquare. A <a href="http://pcklab.com">NEW YEAR</a> creation', 'whitesquare'); ?></p>
                </div>
            </div>
        <?php wp_footer(); ?>
            </footer>
